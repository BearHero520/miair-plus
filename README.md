...
**当前为 `2.0.0-alpha.3` 预览版。已做协议与解码自动测试，尚未完成 fnOS、真实小爱音箱、QQ 音乐／网易云／OPPO／Apple 发送端的实机验收。不要把预览版当作全型号兼容的稳定版。**
...
1. 从 Releases 下载 `miair-plus-2.0.0-alpha.3-all.fpk`，x86_64 与 ARM64 使用同一个安装包。
