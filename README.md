...
**当前为 `2.0.0-alpha.5` 预览版。已做协议与解码自动测试，已在 x86_64 fnOS 验证升级与启动；尚未完成真实小爱音箱、QQ 音乐／网易云／OPPO／Apple 发送端的实机验收。不要把预览版当作全型号兼容的稳定版。**
...
1. 从 Releases 下载 `miair-plus-2.0.0-alpha.5-all.fpk`，x86_64 与 ARM64 使用同一个安装包。
