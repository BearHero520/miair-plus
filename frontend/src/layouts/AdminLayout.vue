<template>
 <div class="app-workspace">
  ...
  <aside class="app-sidebar glass">
   ...
   <div class="sidebar-bottom"><span class="sidebar-label">MiAir Plus</span><small>2.0.0-alpha.4</small></div>
  </aside>
...
import {GridOutline,VolumeHighOutline,PersonOutline,SettingsOutline,DocumentTextOutline,SunnyOutline,MoonOutline,RadioOutline} from '@vicons/ionicons5'
...
const descriptions:Record<string,string>={devices:'管理音箱与投送名称',account:'连接小米账号，选择音箱',settings:'投送、连接与外观',logs:'查看投送记录，定位连接与播放问题'}
</script>
